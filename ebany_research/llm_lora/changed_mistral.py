...
class MistralMLP(nn.Module):
    ...
    def forward(self, x):
        ...
        #     "gate_proj.weight": self.gate_proj.weight.data,
        #     # "act_fn(gate_proj)": act_fn,
        #     # "up_proj(x)": up_proj,
        #     # "up_proj.weight": self.up_proj.weight.data,
        #     # "act_fn_up_proj": act_fn_up_proj,
...
class MistralModel(MistralPreTrainedModel):
    ...
    def forward(
        ...
        for layer_pos, decoder_layer in enumerate(self.layers):
